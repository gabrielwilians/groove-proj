...
<html lang="pt_BR">
  <head>
    ...
    <title>area do cliente - goovel</title>
...
<header class="w3l-header">
	...
	<nav class="navbar navbar-expand-lg navbar-light fill px-lg-0 py-0 px-sm-3 px-0">
			<a class="navbar-brand" href="index.html">
				<span class="fa fa-newspaper-o"></span> <?php
            include('../login/config.php');
            if($_SESSION['login'] != true){
                header('Location: index.php');
                die();
            }
            echo 'goovel - '.$_SESSION['nome']." ".$_SESSION['sobrenome']." ";
            if(isset($_GET['sair'])){
              session_destroy();
                header('Location: ../index.php');
                die();
            ...
            <div class="col-lg-3 col-6 grids-feature">
                <a href="fashion.html">
                    <div class="area-box">
                        ...
                        <h4 class="title-head">Mídias Sociais</h4>
                    </div>
                </a>
            </div>
            ...
            <div class="col-lg-3 col-6 grids-feature mt-lg-0 mt-md-4 mt-3">
                <a href="#lifsetyle">
                    <div class="area-box">
                        ...
                        <h4 class="title-head">E-commerce</h4>
                    </div>
                </a>
            </div>
        </div>
...
<div class="w3l-homeblock2 w3l-homeblock6 py-5">
    <div class="container-fluid px-sm-5 py-lg-5 py-md-4">
        <!-- block -->
            <h3 class="section-title-left mb-4"> Novidades!!!!</h3>
        <div class="row">
            <div class="col-lg-6">
                <div class="bg-clr-white hover-box">
                    <div class="row">
